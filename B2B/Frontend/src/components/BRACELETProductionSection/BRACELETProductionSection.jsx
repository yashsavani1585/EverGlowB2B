...
import PromotionalBanner2 from "../../assets/productAds10.png";
import PromotionalBanner3 from "../../assets/productAds11.png";
import PromotionalBanner1 from "../../assets/productAds12.png";
import useCategoryProducts from "../../hooks/useCategoryProducts";

const BRACELETProductionSection = () => {
  const { items: products = [], loading } = useCategoryProducts("bracelet");
...
export default BRACELETProductionSection;
